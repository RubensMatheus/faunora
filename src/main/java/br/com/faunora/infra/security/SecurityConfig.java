...
//                .csrf(AbstractHttpConfigurer::disable)
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173")); // Permitir origem do frontend
        ...
        configuration.setAllowCredentials(true); // Permitir envio de cookies e credenciais (se necessário)

        UrlBasedCorsConfigurationSource source = new UrlBasedCorsConfigurationSource();
        source.registerCorsConfiguration("/**", configuration); // Aplicar configurações a todos os endpoints
        return source;
    }
